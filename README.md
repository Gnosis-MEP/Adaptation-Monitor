...
But in order to make the automatic docker image build work, you'll need to set the `SIT_PYPI_USER` and `SIT_PYPI_PASS` variables in the Gitlab CI setting page: [Adaptation Monitor CI Setting Page](https://gitlab.insight-centre.org/sit/mps/adaptation-monitor/settings/ci_cd).
